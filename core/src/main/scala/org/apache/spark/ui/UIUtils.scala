...
private[spark] object UIUtils extends Logging {
  ...
  // Yarn必须经过一个代理，以便提供基本的uri，并且必须在所有的链接上
  def uiRoot: String = {
  ...
  def commonHeaderNodes: Seq[Node] = {
    ...
    /*
       spark主页的头部信息
       http://bigdata02.hzjs.co:8088/proxy/application_1510713216020_1635/

       <meta http-equiv="Content-type" content="text/html; charset=utf-8">
       <link rel="stylesheet" href="/proxy/application_1510713216020_1635/static/bootstrap.min.css" type="text/css">
       <link rel="stylesheet" href="/proxy/application_1510713216020_1635/static/vis.min.css" type="text/css">
       <link rel="stylesheet" href="/proxy/application_1510713216020_1635/static/webui.css" type="text/css">
       <link rel="stylesheet" href="/proxy/application_1510713216020_1635/static/timeline-view.css" type="text/css">
       <script src="/proxy/application_1510713216020_1635/static/sorttable.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/jquery-1.11.1.min.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/vis.min.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/bootstrap-tooltip.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/initialize-tooltips.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/table.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/additional-metrics.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/timeline-view.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/log-view.js"></script>
       <script src="/proxy/application_1510713216020_1635/static/webui.js"></script>
       <script>setUIRoot('/proxy/application_1510713216020_1635')</script>
     */
  }
  ...
  def headerSparkPage(
    ...
    // spark界面的 jobs Stages Storage Environment Executor
    ...
    /**
      * 这些html代码是整个Spark某个Application对应的主页（也是job主页）
      */
    <html>
      <head>
        {commonHeaderNodes}                                         <!-- title里面的内容 -->
          ...
          <div class="navbar-inner">
            <div class="brand">
              <a href={prependBaseUri("/")} class="brand">
                <img src={prependBaseUri("/static/spark-logo-77x50px-hd.png")} />  <!-- Spark的图标 -->
                <span class="version">{org.apache.spark.SPARK_VERSION}</span>      <!-- Spark的版本 -->
              </a>
            </div>
            <p class="navbar-text pull-right">
              <strong title={appName}>{shortAppName}</strong> application UI       <!-- qqOperateHbase_spark application UI-->
            </p>
            <ul class="nav">{header}</ul>                                          <!-- spark界面的 jobs Stages Storage Environment Executor 按钮-->
          </div>
        </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <h3 style="vertical-align: bottom; display: inline-block;">
                {title}                                                            <!-- Spark Jobs (?)中的Spark Jobs -->
                {helpButton}                                                       <!-- Spark Jobs (?)中的小问号按钮 -->
              </h3>
            </div>
          </div>
          {content}                                                                <!-- 剩下的都是在这里显示-->
