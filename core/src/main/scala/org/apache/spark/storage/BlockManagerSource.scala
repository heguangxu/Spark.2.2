...
/**
  ...
  DAGSchedulerSource，BlockManagerSource的过程类似于ExecutorSource，只不过DAGSchedulerSource的测量信息是stage.faileStages
  ,satage.runningStages,stage.waitting-Stages,stage.allJobs,stage.activeJobs.   BlockManagerSource测量信息是
  memory.maxMem_MB,memoery.remainingMem_MB,memory.memUsed_MB，memory.diskSpaceUsed_MB.
  */
