...
// Spark使用一个自定义的fork sbt-pom-reader插件包含了一个补丁以解决相关问题test-jar依赖性
// (https://github.com/sbt/sbt-pom-reader/pull/14)。 这个fork发表在
// https://github.com/JoshRosen/sbt-pom-reader/tree/v1.0.0-spark和对应提交b160317fcb0b9d1009635a7c5aa05d0f3be61936库。
// 从长远来看，我们应该尝试将我们的补丁合并到一个上游版本的插件;这是在spark - 14401上跟踪的。
